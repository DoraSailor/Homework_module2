...
#
# print(pop[:,2020])
# pop_df=pop.unstack()# из Series с Мультииндексом в DataFrame
# print(pop_df)
...
# # взять столбец 'something' только для 'city_1')
# # взять столбцы 'something' и 'total' для 'city_1' и 'city_3'
# # взять столбец 'something' для 'city_1' и 'city_3'
#
#
...
# i4=pd.MultiIndex(levels=[['a','b','c'],[1,2]],codes=[[0,0,1,1,2,2], # a a b b
#                                                  [0,1,0,1,0, 1]])# 1 2 1 2
# print(i4)
#
...
# print(s)
# dataframe - можно переименовывать не только столбцы, но и строки
...
# print(data)
# # print(data['a':'b']) ошибка надо пересортировать
